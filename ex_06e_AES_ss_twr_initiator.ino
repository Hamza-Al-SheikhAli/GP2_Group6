...
#define SPEED_OF_LIGHT_CM 29979245800.0
// connection pins
...
static uint8_t tx_poll_msg[] = {'D','R','.','S','H','U','R','M','A','N'};
...
void loop() {
        ...
        {/* Got response */
                    ...
                    aes_job_rx.payload_len-START_RECEIVE_DATA_LOCATION) == 0)
            {
                ...
                distance = tof * SPEED_OF_LIGHT_CM;

                /* Display computed distance on LCD. */
                snprintf(dist_str, sizeof(dist_str), "DIST: %3.0f cm", distance);
